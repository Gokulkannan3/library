...
export default function Asignup() {
  ...
  const addUser = (e) => {
    ...
    Axios.post(`http://localhost:3080/registeradmin`, {
      adminname: adminname,
      password:password,
      cpassword:cpassword,
    })
      ...
      <form>
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          <div class="sm:col-span-6">
            ...
            <div class="mt-2">
              <input type="text" onChange={(e)=>{setAdminname(e.target.value);}} name="first-name" id="first-name" maxLength={20} autocomplete="given-name" class="block w-full text-center rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-red-500 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-red-500 sm:text-sm sm:leading-6"/>
            </div>
          </div>
        </div>
